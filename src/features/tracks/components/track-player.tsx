                                                    ...
                                                    <AccordionItem value={`season-${key}`} key={key}>
                                                        ...
                                                        <AccordionContent>
                                                            {season.episodes.map((episode) => (
                                                                <button className={cn("text-xs font-medium text-neutral-200 p-2.5 rounded-md transition hover:bg-neutral-900 w-full flex justify-between hover:text-white", episode.id === data.currentEpisode?.id && "pointer-events-none text-white bg-neutral-900")}>
                                                                    <p>
                                                                        {episode.title}
                                                                    </p>
